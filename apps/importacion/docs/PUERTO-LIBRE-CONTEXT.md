...
Documento de referencia para agentes/IA. Toda respuesta sobre importación, SENIAT, aduana, planilla o expedientes PL debe basarse aquí. Stack: Next.js 14 App Router, Server Actions, Supabase (JSONB), Zod, Tailwind. Base path: `/importacion`. App independiente de SmartTaller; misma base Supabase. No inventar rutas, columnas ni campos que no estén aquí.
