/** Dominio de producción de Puerto Libre (override con NEXT_PUBLIC_APP_URL). */
export const PRODUCTION_APP_HOST = "puertolibre.xyz";
...
/**
 * URL base pública (PDFs, emails, NFC, Auth callback).
