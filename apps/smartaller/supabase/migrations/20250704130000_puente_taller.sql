...
-- Mantenimientos visibles para dueños cuya placa coincide con su vehículo en /app
...
-- Recordatorios: dueño ve recordatorios de vehículos con su placa (incluye filas del taller)
...
-- Talleres: el dueño puede ver el nombre del taller que atendió su vehículo
