-- SmartTaller — Parche si ya tenías setup-completo hasta 4 jul 2026
-- Ejecutar SOLO si NO tienes: Stripe en perfiles, SmartBike, diagnóstico, repuestos.
-- Si la base es nueva, usa ../setup-completo.sql en su lugar.
--
-- Incluye migraciones:
--   20250705100000_stripe_perfiles
--   20250706100000_mantenimientos_update_categorias
--   20250707100000_smartbike
--   20250708100000_diagnostico_media
--   20250709100000_repuestos
--   20250710100000_smartbike_vehiculo_link
