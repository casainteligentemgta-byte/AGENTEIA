...
type Tab = "fases" | "flujo";

const TABS: { id: Tab; label: string }[] = [
  { id: "fases", label: "Por fases" },
  { id: "flujo", label: "Por flujo" },
];

export function CuestionarioValidacionView() {
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-5 flex flex-wrap items-center gap-2 print:hidden">
              ...
              <button
                ...
                className={
                  tab === item.id
                    ...
                    : "rounded-lg px-3 py-2 text-sm font-medium text-zinc-400 hover:text-zinc-100"
                }
              >
                {item.label}
              </button>
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-xl border border-zinc-700 px-3 py-2 text-sm font-medium text-zinc-200 hover:border-cyan-500/40"
          >
