...
export function OdometerCard({ vehiculo, ultimaVisita, ultimoCentro }: OdometerCardProps) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl bg-brand-600 text-white shadow-lg shadow-brand-600/25">
      <div className="flex items-center gap-4 p-5">
        ...
        <div>
          ...
          {ultimaVisita && (
            <p className="mt-2 text-[11px] font-medium tracking-wide text-brand-100">
      ...
      {ultimoCentro && (
        <div className="flex items-start gap-2 border-t border-white/25 bg-brand-700/40 px-5 py-3">
          <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-white/90" />
          <p className="text-[11px] font-medium leading-snug tracking-wide text-brand-50">
