...
const btnBase =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-xl px-[18px] text-[15px] font-medium transition-[background,border-color] duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-landing-accent";
...
export function Header() {
  return (
    <header className="sticky top-0 z-10 border-b border-landing-line bg-landing-bg/92 pt-[env(safe-area-inset-top,0px)] backdrop-blur-[8px]">
      <div className={wrap}>
        <a
          className="flex items-center gap-2.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-landing-accent focus-visible:rounded-md"
          href="#inicio"
        ...
        <nav className="flex items-center gap-7" aria-label="Principal">
          <a
            className="hidden text-[15px] text-landing-text-2 hover:text-landing-text focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-landing-accent focus-visible:rounded-md lp:inline-flex"
            href="#como"
          >
            Cómo funciona
          </a>
