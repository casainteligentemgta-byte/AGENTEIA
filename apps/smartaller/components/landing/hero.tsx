...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-28">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-brand-900/20 via-zinc-950 to-zinc-950" />
      <div className="pointer-events-none absolute -top-24 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-brand-600/10 blur-3xl" />
        ...
        <div className="mx-auto max-w-3xl text-center animate-fade-in">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-brand-600 px-6 py-3 text-base font-medium text-white shadow-lg shadow-brand-600/25 transition hover:bg-brand-500"
            >
              Panel del taller
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-brand-500/40 bg-brand-500/10 px-6 py-3 text-base font-medium text-brand-200 transition hover:border-brand-400 hover:bg-brand-500/20"
            >
              App para dueños
            </Link>
            <a
        ...
        <div className="mx-auto mt-16 grid max-w-4xl gap-4 sm:grid-cols-3 animate-slide-up">
          {[
            ...
            <div key={label} className="glass rounded-2xl p-5 text-center">
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-zinc-800 text-brand-400">
