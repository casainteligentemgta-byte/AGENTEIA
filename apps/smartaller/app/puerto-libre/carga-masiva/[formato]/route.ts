...
import { buildCargaMasivaCsvTemplate } from "@/lib/puerto-libre/carga-masiva-template";
import { buildCargaMasivaXlsxBuffer } from "@/lib/puerto-libre/parse-spreadsheet";
...
export async function GET(_req: Request, { params }: Params) {
  ...
  if (!user) {
    return NextResponse.redirect(new URL("/login?next=/puerto-libre/carga-masiva", _req.url));
  }
