...
function mapDocuments(raw: unknown): NfcDocumentPublic[] {
  ...
  const entries: Array<{ key: keyof typeof docs; label: string }> = [
    ...
    { key: "factura_comercial", label: "Factura comercial / contrato" },
    { key: "bl_guia", label: "BL / conocimiento de embarque" },
    { key: "certificado_origen", label: "Certificado de origen" },
    { key: "permiso_importacion", label: "Permiso de importación" },
    { key: "nacionalizacion", label: "Liquidación aduanera (CVA / DUA)" },
    ...
    { key: "inspeccion_pnb", label: "Inspección PNB" },
    { key: "homologacion", label: "Homologación" },
    { key: "planilla_sumica_put", label: "PUT (planilla SUMICA)" },
    { key: "pago_tasas", label: "Planilla de pago" },
